...
export function flattenTemplates(categories: TemplateCategory[]): TemplateInfo[] {
...
export function getTopByUsage(templates: TemplateInfo[], limit?: number): TemplateInfo[] {
