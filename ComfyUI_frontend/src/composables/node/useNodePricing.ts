...
const formatCreditsLabel = (
  ...
  `${makePrefix(approximate)}${formatCreditsValue(usd)}${makeSuffix(suffix)}${appendNote(note)}`
...
const formatCreditsRangeLabel = (
  ...
  return `${makePrefix(approximate)}${rangeValue}${makeSuffix(suffix)}${appendNote(note)}`
}
...
const formatCreditsListLabel = (
  ...
  return `${makePrefix(approximate)}${value}${makeSuffix(suffix)}${appendNote(note)}`
}
