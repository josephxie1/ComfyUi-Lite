...
import SaveTemplateDialog from '@/components/dialog/content/SaveTemplateDialog.vue'
import { t } from '@/i18n'
...
const ext: ComfyExtension = {
  ...
  getCanvasMenuItems(_canvas: LGraphCanvas): IContextMenuValue[] {
    ...
    items.push({
      content: t('contextMenu.Save Workflow as Template', 'Save Workflow as Template'),
      callback: () => {
        useDialogStore().showDialog({
          key: 'save-user-template',
          title: t('contextMenu.Save Workflow as Template', 'Save Workflow as Template'),
