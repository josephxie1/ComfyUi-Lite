<template>
  ...
  >
    ...
    <template #tool-buttons>
      <!-- Kept empty to prevent toolbar from having tools, placing them under header instead -->
    </template>
    <template #header>
      <div class="flex items-center gap-3 px-2 pb-1 2xl:px-4">
        <div class="grow min-w-0">
          <SearchInput
            ref="searchBoxRef"
            v-model:model-value="searchQuery"
            class="workflows-search-box w-full"
        ...
        <div class="flex items-center gap-1.5 shrink-0">
          ...
          <div
            v-if="!isSearching"
            v-tooltip.top="$t('sideToolbar.mediaAssets.viewSettings')"
            class="inline-flex items-center"
          >
            <WorkflowSettingsButton>
              <template #default>
                <WorkflowSettingsMenu v-model:view-mode="viewMode" />
              </template>
            </WorkflowSettingsButton>
          </div>
          <div
            v-tooltip.top="$t('g.refresh')"
            class="inline-flex items-center"
          >
            <Button
              variant="secondary"
    ...
    <template #body>
      <div v-if="!isSearching" class="comfyui-workflows-panel">
        ...
        <div class="comfyui-workflows-browse">
          ...
          />
          <WorkflowGrid
            v-if="filteredPersistedWorkflows.length > 0 && viewMode === 'grid'"
            :root="renderTreeNode(workflowsTree, WorkflowTreeType.Browse)"
          />
          <TreeExplorer
            v-else-if="filteredPersistedWorkflows.length > 0 && viewMode === 'list'"
...
import WorkflowGrid from '@/components/sidebar/tabs/workflows/WorkflowGrid.vue'
import TreeExplorerTreeNode from '@/components/common/TreeExplorerTreeNode.vue'
import SidebarTabTemplate from '@/components/sidebar/tabs/SidebarTabTemplate.vue'
import WorkflowSettingsButton from '@/components/sidebar/tabs/workflows/WorkflowSettingsButton.vue'
import WorkflowSettingsMenu from '@/components/sidebar/tabs/workflows/WorkflowSettingsMenu.vue'
